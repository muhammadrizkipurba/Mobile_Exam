    ...
    render () {
        ...
        if(this.state.authMode === 'signup'){
            ...
            headingTextControl = (
                <View>
                    <MainText>
                        <HeadingText>Muhammad Rizki Purba</HeadingText>
                    </MainText>
                    <MainText>
            ...
            submitButtonControl = (
                <ButtonWithBackground color='#FFA07A' onTekan={this.loginHandler}>
                    Login
                </ButtonWithBackground>
            )
        ...
        return (
            <ImageBackground source={imageBackground} style={styles.backgroundImage}>
                <KeyboardAvoidingView behavior='padding' style={styles.container}>
                    {headingTextControl}
                    <ButtonWithBackground color='#FFA07A' onTekan={this.switchAuthModeHandler}>
